...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public List<User> findRode(String queryname, Integer queryUserRole) throws RuntimeException {
        return userMapper.selectfindRode(queryUserRole, queryname);
    }
    @Override
    @Transactional(propagation = Propagation.SUPPORTS,readOnly = true)
    public User findUsersByCode(String userCode) {
        if (userCode!=null) {
    ...
    @Override
    public User findUserById(Integer userId) throws BusinessExcpetion {
        return  userMapper.selectUserById(userId);
    }

    @Override
    public Integer modifyUser(User user) throws BusinessExcpetion {
